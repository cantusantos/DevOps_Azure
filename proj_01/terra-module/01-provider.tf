terraform {
  ...
  backend "azurerm"{
    ...
    key                 ="terraform.tfstate"          # this is a file inside the container state
  }
...
provider "azurerm" {
  ...
  client_id       = "0f9f03c8-bf62-4c93-bee3-102b57b9c0ef"
  client_secret   = "gQA8Q~g_NLGo-e_sSTEjKXX444hVI5SIyOhaIcs2"
  features {}
}
